...
rentInfo.addressToPerson(currentAccount, function(error, result) {

$("#ethUser").html(result[0]);
$("#nameUser").html(result[1]);
$("#emailUser").html(result[2]);
});

rentInfo.getDetails(function(error, result) {

$("#aadhaarUser").html(result[0]['c']);
...
var isValid = [], tenantApproval = [], govApproval = [], checkRegisterFee = [], checkSecurityFee = [];
